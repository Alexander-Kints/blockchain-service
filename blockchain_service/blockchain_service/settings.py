...
if os.path.exists(env_filepath):
    ...
    print('file', env_filepath, 'not found')
    sys.exit(6)
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Docs',
    'DESCRIPTION': 'Blockchain-service API docs',
    'VERSION': '1.0.0',
...
ROOT_URLCONF = 'blockchain_service.urls'
...
WSGI_APPLICATION = 'blockchain_service.wsgi.application'
